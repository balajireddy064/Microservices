...
public class SearchSpecification implements Specification<CashReceiptEntity> {
	private static final long serialVersionUID = 1L;

	String userSearch;

	public SearchSpecification(String userSearch) {
		super();
		this.userSearch = userSearch;
	}

	@Override
	public Predicate toPredicate(Root<CashReceiptEntity> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
