package com.ayusha.general.services.constants;
 ...
 *
 */
public class GeneralServicesConstants {
	...
	/** Job Notes Get Service Name **/
	public final static String GET_ALL_COUNTRY_SERVICE_NAME="general/country/findall";
	/** Job Notes Get Service Name **/
	...
	/** Job Notes Get Service Name **/
	public final static String GET_CITY_SERVICE_NAME="general/city/find?citycode=$1";
	

	/** Job Notes Get Service Name **/
	public final static String GET_CITY_STATE_SERVICE_NAME="general/city/findAll?statecode=$1";
	/** Job Notes Get Service Name **/
	public final static String UPDATE_CITY_SERVICE_NAME="general/city/update/";
	
	/** Job Notes Get Service Name **/
	public final static String ADD_CITY_SERVICE_NAME="general/city/add";
}
