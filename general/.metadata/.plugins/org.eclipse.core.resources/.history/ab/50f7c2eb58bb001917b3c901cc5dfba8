 ...
 */
@Service
public class RepairNotesService implements IRepairNotesService{
	
	/** LOGGER **/
	private static Logger LOG = LogManager.getLogger(RepairNotesService.class);
